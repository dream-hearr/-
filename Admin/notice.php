  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        <h1 class="page-header">公告操作</h1>
        <ol class="breadcrumb">
          <li><a href="add-notice.php">增加公告</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            ...
            for ($i=0;$i<$n;$i++){
             ...
             echo "<tr>             	
                ...
                <td>$date[$i]</td>
                <td><a href='php/delete_notice.php?nid=$nid[$i]'>&nbsp;&nbsp;&nbsp;&nbsp;删除</a></td>
             </tr>";}}
             ?>
            </tbody>
          </table>
