...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
      	<!--//上传文件enctype="multipart/form-data">-->
        <form action="../Admin/php/check_article.php" method="post" class="add-article-form" enctype="multipart/form-data">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <span class="prompt-text">每天都是元气满满的一天呢！</span>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>发布于：</label><span class="article-time-display"><?php echo date("Y-m-d");?></span></p>
              </div>
              <div class="add-article-box-footer">
