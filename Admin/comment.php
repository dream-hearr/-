      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['username'];?></a>
            </li>
          ...
          <table class="table table-striped table-hover">
            ...
            for ($i=0;$i<$n;$i++){
             ...
             echo "<tr>             	
                ...
                <td class='article-title'>$username[$i]:";
                	content($c_id);
                	echo "</td>
                <td>$date[$i]</td>
                <td><a href='php/delete_comment.php?id=$id[$i]'>&nbsp;&nbsp;&nbsp;&nbsp;删除</a></td>
             </tr>";}}
             ?>
            </tbody>
          </table>
